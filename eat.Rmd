...
colPerc(table1)
```
So the tables show, how white eat out more compared to blacks, and other. Other is at about 78%, and only 22% of them are saying they do not eat out.
...
The p-value from the Chi-Square statistic is 0.0008, which is lower than 0.05. The null hypothesis is rejected. 
